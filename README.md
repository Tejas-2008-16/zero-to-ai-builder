...
|---|---|---|
| **[Learn Python – Full Course for Beginners](https://www.youtube.com/watch?v=rfscVS0vtbw)**<br>freeCodeCamp / Mike Dane · 4 hrs total — **watch in 45-min daily chunks using the video's timestamps** | Variables, strings, numbers, lists, tuples, dictionaries, if-statements, loops, functions, classes, file reading/writing, error handling — taught through small builds like a calculator and a translator | 💻 Practice: build a number guessing game + a console to-do list |
| **[Python Classes and Objects](https://www.youtube.com/watch?v=ZDa-Z5JzLYM)**<br>Corey Schafer · ~1 hr, split over 2 days | Classes, `__init__`, instance vs. class attributes, inheritance — the exact pattern you'll reuse to structure your AI app (e.g. an `EmailWriter` class) | 💻 Practice: write a `Note` class with `add_note()`, `delete_note()`, and save/load from a `.txt` file |

**🚀 Mini Project:** *Command-line Journal App* — write, save, and read journal entries from a text file using functions and classes.
